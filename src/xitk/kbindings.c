...
static kbinding_entry_t default_binding_table[] = {
  ...
  { "Menu 0 event.",
    "EventMenu0",             ACTID_EVENT_MENU3             , "Escape",   KEYMOD_NOMOD   , 0 },
  { "Menu 2 event.",
    "EventMenu2",             ACTID_EVENT_MENU2             , "F1",       KEYMOD_NOMOD   , 0 },
  { "Menu 3 event.",
    "EventMenu3",             ACTID_EVENT_MENU3             , "F2",       KEYMOD_NOMOD   , 0 },
  { "Menu 4 event.",
    "EventMenu4",             ACTID_EVENT_MENU4             , "F3",       KEYMOD_NOMOD   , 0 },
  { "Menu 5 event.",
    "EventMenu5",             ACTID_EVENT_MENU5             , "F4",       KEYMOD_NOMOD   , 0 },
  { "Menu 6 event.",
    "EventMenu6",             ACTID_EVENT_MENU6             , "F5",       KEYMOD_NOMOD   , 0 },
  { "Menu 7 event.",
    "EventMenu7",             ACTID_EVENT_MENU7             , "F6",       KEYMOD_NOMOD   , 0 },
  { "Up event.",
