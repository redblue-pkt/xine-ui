...
static kbinding_entry_t default_binding_table[] = {
  ...
  { "Reduce the output window horizontal size by one pixel.",
    "WindowReduceHPixel",     ACTID_WINDOWREDUCE_H_PIXEL    , "less",     KEYMOD_CONTROL },
  { "Reduce the output window vertical size by one pixel.",
    "WindowReduceVPixel",      ACTID_WINDOWREDUCE_V_PIXEL   , "less",     KEYMOD_META    },
  { "Reduce the output window (H/V) size by one pixel.",
    "WindowReducePixel",      ACTID_WINDOWREDUCE_PIXEL      , "less",     KEYMOD_CONTROL | KEYMOD_META },
  { "Enlarge the output window size by factor 1.2.",
    "WindowEnlarge",          ACTID_WINDOWENLARGE           , "greater",  KEYMOD_NOMOD   },
  { "Enlarge the output window horizontal size by one pixel.",
    "WindowEnlargeHPixel",     ACTID_WINDOWENLARGE_H_PIXEL  , "greater",  KEYMOD_CONTROL },
