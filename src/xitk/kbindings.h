...
typedef enum {
  ACTID_NOKEY = 0,
  ACTID_WINDOWREDUCE,
  ACTID_WINDOWREDUCE_H_PIXEL,
  ACTID_WINDOWREDUCE_V_PIXEL,
  ACTID_WINDOWREDUCE_PIXEL,
  ACTID_WINDOWENLARGE,
  ACTID_WINDOWENLARGE_H_PIXEL,
  ACTID_WINDOWENLARGE_V_PIXEL,
  ACTID_WINDOWENLARGE_PIXEL,
  ACTID_SPU_NEXT,
  ACTID_SPU_PRIOR,
  ACTID_CONTROLSHOW,
